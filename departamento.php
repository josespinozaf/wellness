...
echo html_writer::tag ( 'div', 'Presidente Deportes UAI', array (
		'class' => 'descasd' 
) );
echo html_writer::tag ( 'div', '<b>Nombre Apellido</b>', array (
		'class' => 'descasd' 
) );
...
echo html_writer::tag ( 'div', 'Sub-Presidente Deportes UAI', array (
		'class' => 'descasd' 
) );
echo html_writer::tag ( 'div', '<b>Nombre Apellido</b>', array (
		'class' => 'descasd' 
...
echo html_writer::tag ( 'div', 'Profesor Trekking', array (
		'class' => 'descasd' 
) );
echo html_writer::tag ( 'div', '<b>Nombre Apellido</b>', array (
		'class' => 'descasd' 
...
echo html_writer::tag ( 'div', 'Profesora RPM', array (
		'class' => 'descasd' 
) );
echo html_writer::tag ( 'div', '<b>Nombre Apellido</b>', array (
		'class' => 'descasd' 
